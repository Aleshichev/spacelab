...
@logger.catch
def scrape_laptops(number, flag, data):
    logger.info(f'Enter in the scrape_laptops() function data = {number}, {flag}, {data}')
    try:
        while flag:
            number += 1
            print(number)
        ...
        logger.error(f"Страницы закончились")
        ...
        logger.info(f'Файл data.json создан')


           
if __name__ == '__main__':

    scrape_laptops(number, flag, data)
